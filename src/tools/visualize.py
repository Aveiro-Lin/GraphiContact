...
def gen_render(img, contact_labels_3d_pred, contact_2d_pred_rgb, sem_mask_pred, part_mask_pred, normalize=True):
...
#             gt_mesh.visual.vertex_colors[vid] = color
    ...
    contact_labels_3d_pred = contact_labels_3d_pred[ :]
    ...
    sem_mask_pred = np.transpose(sem_mask_pred, (1, 2, 0))*255
    ...
    part_mask_pred = np.transpose(part_mask_pred, (1, 2, 0))*255
